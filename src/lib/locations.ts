...
export const chinaRegions: ChinaRegion[] = [
  { id: 'northeast', name: '东北', cities: ['大连', '沈阳', '长春', '哈尔滨'], provinces: ['辽宁', '吉林', '黑龙江'], shape: 'M430 86 L552 62 L620 120 L586 220 L488 216 L438 160 Z' },
  ...
  { id: 'east', name: '华东', cities: ['上海', '苏州', '杭州', '南京', '宁波', '无锡', '合肥', '厦门', '福州'], provinces: ['上海', '江苏', '浙江', '安徽', '福建'], shape: 'M462 292 L560 304 L600 408 L542 502 L440 462 L402 360 Z' },
  { id: 'central', name: '华中', cities: ['武汉', '长沙', '郑州', '洛阳', '南昌'], provinces: ['湖北', '湖南', '河南', '江西'], shape: 'M342 286 L462 292 L440 462 L320 472 L258 378 Z' },
  { id: 'south', name: '华南', cities: ['深圳', '广州', '东莞', '佛山', '珠海', '南宁', '海口'], provinces: ['广东', '广西', '海南'], shape: 'M320 472 L440 462 L542 502 L486 590 L354 604 L276 540 Z' },
